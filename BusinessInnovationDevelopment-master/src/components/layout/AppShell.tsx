...
function AppShellContent({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-foreground">
      <div className="mobile-app relative mx-auto flex min-h-screen w-full max-w-[430px] flex-col overflow-hidden bg-cgsi-grey shadow-2xl">
        <header className="sticky top-0 z-30 border-b bg-white/95 px-3 py-2.5 shadow-sm backdrop-blur">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0 flex-1 leading-tight">
              <div className="truncate text-sm font-semibold text-cgsi-navy">
                CGSI Invest Assist
              </div>
        ...
        <nav className="fixed bottom-0 left-1/2 z-40 grid h-14 w-full max-w-[430px] -translate-x-1/2 grid-cols-5 border-t bg-white/95 shadow-[0_-8px_24px_rgba(15,23,42,0.08)] backdrop-blur">
          {nav.map((item) => {
            ...
            return (
              ...
              >
                <span
                  className={`rounded-full px-2.5 py-0.5 ${active ? "bg-cgsi-green-soft" : ""}`}
                >
