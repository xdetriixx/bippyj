...
export const SentimentAttentionMap: React.FC<SentimentAttentionMapProps> = ({ companyName, score }) => {
  ...
  }, [companyName, score, seed, normName]);
  ...
  return (
    <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-3xs space-y-4 text-left" id="sentiment_audit_module">
      ...
      <div className="flex items-center justify-between pb-3.5 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] text-slate-400">Natural language analysis on corporate filing archives</p>
          </div>
        </div>
      ...
      <div className="space-y-3.5 pt-1">
        ...
        <div className="bg-slate-50/50 border border-slate-150 p-3.5 rounded-xl flex flex-col justify-between space-y-3 animate-fade-in" id="sentiment_density_card">
          <div>
          ...
          <div className="space-y-2 pt-2 border-t border-slate-100/60">
            ...
            <div className="h-1.5 w-full bg-slate-150 rounded-full overflow-hidden flex">
              <div style={{ width: `${positiveRatio}%` }} className="bg-emerald-500 h-full transition-all duration-300" />
              <div style={{ width: `${100 - positiveRatio}%` }} className="bg-[#F27D26] h-full transition-all duration-300" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3" id="sentiment_anchors_row">
          ...
          <div className="bg-slate-50/50 border border-slate-150 p-3.5 rounded-xl flex flex-col justify-between space-y-3 relative overflow-hidden animate-fade-in" id="sentiment_pos_anchor">
            <div>
            ...
            <div className="text-[9px] text-slate-500 leading-snug font-normal pt-2 border-t border-slate-100/60">
              Appears <strong className="text-slate-800 font-bold font-mono">{companyData.highestPositiveCount}x</strong> search frequency.
            </div>
          </div>

          {/* PEAK NEGATIVE ANCHOR */}
          <div className="bg-slate-50/50 border border-slate-150 p-3.5 rounded-xl flex flex-col justify-between space-y-3 relative overflow-hidden animate-fade-in" id="sentiment_neg_anchor">
            <div>
              <div className="flex justify-between items-center border-b border-slate-100 pb-1.5 mb-2">
                <div className="text-[8.5px] font-mono text-slate-400 font-bold uppercase tracking-widest leading-none flex items-center gap-1">
            ...
            <div className="text-[9px] text-slate-500 leading-snug font-normal pt-2 border-t border-slate-100/60">
              Appears <strong className="text-slate-800 font-bold font-mono">{companyData.highestNegativeCount}x</strong> risk mentions.
            </div>
          </div>
        ...
        <div className="bg-slate-50/50 border border-slate-150 p-3.5 rounded-xl flex flex-col justify-between space-y-3 animate-fade-in" id="sentiment_verdict_card">
          <div>
            <div className="text-[8.5px] font-mono text-slate-400 font-bold uppercase tracking-widest leading-none flex items-center gap-1.5 border-b border-slate-100 pb-1.5 mb-2">
          ...
          <div className="text-[8.5px] text-slate-450 pt-2 border-t border-slate-100/60 font-mono flex items-center justify-between">
            ...
            <span className="font-extrabold uppercase text-indigo-700 bg-indigo-50 px-1.5 py-0.5 rounded border border-indigo-100/40 text-[8px]">{score >= 75 ? "EXCELLENT" : score >= 50 ? "ADEQUATE" : "VAGUE_WARNING"}</span>
          </div>
        </div>
