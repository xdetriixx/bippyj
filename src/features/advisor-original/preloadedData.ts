import { BMCResult, RubricRule } from './types';
...
export const DEFAULT_RUBRIC_RULES: RubricRule[] = [
  {
    ...
    guidelines: 'Identify distinct groups of people/organizations the organization serves (e.g. HNWI, cross-border families, retail, institutional).',
    keywords: ['Retail', 'Institutional', 'HNWI', 'Accredited', 'Cross-border', 'SME', 'Family office']
  },
  {
    id: 'VP',
          ...
          keyPoints: [
            {
              ...
              description: 'High-Net-Worth Individuals demanding personalized discrete portfolio handling and local asset tracking.',
              evidenceQuote: 'Our core Customer Segment consists of High-Net-Worth Individuals (HNWI) in Singapore and cross-border families requiring private wealth strategies.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
            ...
            },
            {
              ...
              description: 'Families traversing multi-jurisdictional tax boundaries needing custom inheritance rules.',
          ...
          keyPoints: [
            {
              ...
              description: 'Individually compiled asset blueprinting far superior to automated generic wirehouses.',
              evidenceQuote: 'Our Value Proposition is delivering personalized boutique portfolio advisory services paired with direct custom access channels to regional stock markets.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              evidenceQuote: 'we rely on automated smart client portals and high-touch relationship managers.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
            ...
            },
            {
              ...
              description: 'Professional high-trust office base located in Singapore financial hub for face-to-face closure.',
              evidenceQuote: 'high-touch relationship managers who set up direct consults in our physical central office.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              description: 'Individually hosted consulting loops supporting customized account goals and close trust.',
              evidenceQuote: 'we rely on automated smart client portals and high-touch relationship managers who set up direct consults.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              description: 'Steady re-calculating annual commissions that hedge market transactions volatility.',
              evidenceQuote: 'Our primary Revenue Streams are Asset Management Retainer fees (typically 1.2% AUM annually)',
              pageNumber: 'Page 1',
              riskRating: 'Low',
            ...
            },
            {
              ...
              description: 'Transactional commission inflows matching clients trade execution frequencies.',
          ...
          keyPoints: [
            {
              ...
              evidenceQuote: 'Our current Cost Structure consists mainly of High Professional Advisor Salaries',
              pageNumber: 'Page 1',
              riskRating: 'Medium',
          ...
          keyPoints: [
            {
              ...
              evidenceQuote: 'Our advisors currently spend over 4.5 hours on average reading each prospect\'s corporate filings.',
              pageNumber: 'Page 1',
              riskRating: 'High',
          ...
          keyPoints: [
            {
              ...
              description: 'Trusted bank partners storing client assets safely to enable flawless transfers.',
              evidenceQuote: 'We also maintain strategic alliances with prime custodian banks and international scholars who act as key partners.',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              evidenceQuote: 'Our current Cost Structure consists mainly of High Professional Advisor Salaries ($120,000 avg/annum per advisor, which represents our primary labor overhead)',
              pageNumber: 'Page 1',
              riskRating: 'High',
          ...
          keyPoints: [
            {
              ...
              description: 'Local retail investors seeking automated asset handling with low minimum capital thresholds.',
              evidenceQuote: 'Our primary Customer Segment is comprised of Retail Accredited Investors',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              evidenceQuote: 'Our Value Proposition is delivering automated portfolio allocation software',
              pageNumber: 'Page 1',
              riskRating: 'Low',
          ...
          keyPoints: [
            {
              ...
              description: 'Clients operate through our dashboard independently without needing high-paid physical consultants.',
          ...
          keyPoints: [
            {
              ...
              description: 'Dedicating hours validating transactions backgrounds against static rule sets.',
              evidenceQuote: 'Compliance staff spend about 1.5 hours on average reading background documents per transaction.',
              pageNumber: 'Page 2',
              riskRating: 'Medium',
          ...
          keyPoints: [
            {
              ...
              description: 'Cloud storage and compute power subscriptions supporting the core portal.',
              evidenceQuote: 'Software cloud hosting contracts (estimated at $12,000/annum) as our main overhead',
              pageNumber: 'Page 9',
              riskRating: 'Low',
